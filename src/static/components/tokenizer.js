(function () {
  Fig.register("tokenizer", function (el, opts) {
    ...
    input.style.cssText =
      "width:100%;font-family:var(--mono);font-size:0.8rem;padding:0.5em 0.7em;background:var(--wash);color:var(--ink);border:1px solid var(--rule-fine)";
    ...
    el.querySelector("input[type=range]")?.addEventListener?.(
      "input",
      () => {},
    );
    Fig.controls(
